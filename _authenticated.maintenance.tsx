  ...
  head: () => ({
    meta: [
      ...
      { title: "AssetFlow — Enterprise Asset & Resource Management" },
      {
        name: "description",
        content:
          "AssetFlow is a premium enterprise ERP for managing physical assets, shared resources, employees, maintenance, audits and analytics.",
      },
      { name: "author", content: "AssetFlow" },
      { property: "og:title", content: "AssetFlow — Enterprise Asset Management" },
      {
        property: "og:description",
        content: "Manage assets, allocations, bookings, maintenance and audits in one enterprise platform.",
      },
